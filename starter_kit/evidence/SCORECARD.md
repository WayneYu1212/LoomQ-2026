...
- `112` is the official **theoretical ceiling**, not an awarded score. Final submission (Issue #55, branch `max-score/final-112`) has been **accepted**; manual/private judging and organizer hardware traceability review are still pending. Organizers determine the awarded score.
