...
| L2 final-candidate gate | — | LOCALLY VERIFIED / ORGANIZER-SCORED SEMANTICS REMAIN SEPARATE | P0 backend polarity: 5/5; 12 unseen paraphrases: 12/12; balanced 6-case gate: 6/6; interleaved 30-case smoke: 28/30 with one retained provider timeout and one retained semantic backend-ID failure |
...
The historical Clean V2 record remains `499/500` with its retained provider-transient failure. It is not rewritten as evidence for this candidate. The current smoke record is 28/30 with the two failures retained and described in `FINAL_RELEASE_CHECKLIST.md`.
